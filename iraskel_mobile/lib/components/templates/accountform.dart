        ...
        body: FutureBuilder<String?>(
            ...
            builder: (BuildContext context, AsyncSnapshot<String?> user) {
              return FutureBuilder<String?>(
                future: phone,
                builder: (BuildContext context, AsyncSnapshot<String?> phonenumb){
                  return FutureBuilder<String?>(
                future: lastname,
                builder: (BuildContext context, AsyncSnapshot<String?> last){
                  return FutureBuilder<String?>(
                future: firstname,
                builder: (BuildContext context, AsyncSnapshot<String?> first){
                   return FutureBuilder<String?>(
                future: token,
                builder: (BuildContext context, AsyncSnapshot<String?> tok){
                return Card(
                                ...
                                child: SingleChildScrollView(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                           ProfileWidget('assets/images/profile.png',user.data ?? ' '),
                                        //  CustomInput('@ffoulen', setUserName,),
                                          CustomInputWithDefaultValue('@ffoulen', setUserName, user.data ?? ' '),
                                          const Spacing(40),
                                          CustomInputWithDefaultValue('Fouleni', setFirstName, first.data ?? ' '),
                                          const Spacing(40),
                                          CustomInputWithDefaultValue('Foulen', setLastName,last.data ?? ' '),
                                          const Spacing(40),
