...
from producer.resolvers import prod_query, prod_mutation, property_query, property_mutation, upload_mutation
...
district_query, address_query, address_mutation, prod_query, prod_mutation, property_query, property_mutation,upload_mutation], 
