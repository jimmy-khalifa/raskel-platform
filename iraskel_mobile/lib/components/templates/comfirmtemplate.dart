...
class ComfirmTemplate extends StatefulWidget {
  ...
  const ComfirmTemplate(this.imageSrc, this.fitType, this.title, this.txt,
      this.int, this.hinttext);
            ...
            child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  Container(
                    ...
                    child: Button(widget.txt,
                        onpressed), //,MediaQuery.of(context).size.width /10,MediaQuery.of(context).size.height / 80,),
                  )
                ]))));
  }
}
